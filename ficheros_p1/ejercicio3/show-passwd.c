...
int main(int argc, char *argv[])
{
	...
	if((options.inputfile=fopen("/etc/passwd","r"))==NULL){
		fprintf(stderr, "The default input file %s could not be opened: ",
				        optarg);
				perror(NULL);
				exit(EXIT_FAILURE);
	}
